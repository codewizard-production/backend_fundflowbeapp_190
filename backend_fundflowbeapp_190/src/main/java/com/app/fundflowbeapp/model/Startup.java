package com.app.fundflowbeapp.model;
...
import com.app.fundflowbeapp.converter.DurationConverter;
import com.app.fundflowbeapp.converter.UUIDToByteConverter;
import com.app.fundflowbeapp.converter.UUIDToStringConverter;
...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"fundflowbeapp\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"fundflowbeapp\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"fundflowbeapp\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"fundflowbeapp\"")
